        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              generated code artifacts. The Service includes features such as
              code streaming, component variations, and export capabilities.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The code and designs generated by {APPLICATION_NAME} are provided
              to you with a flexible usage license. You are free to use, modify,
              and distribute the generated code in your personal and commercial
              projects.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              However, the underlying software, design of the Service, and all
              other content provided by us (excluding your generated content)
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              You expressly understand and agree that {APPLICATION_NAME} shall
