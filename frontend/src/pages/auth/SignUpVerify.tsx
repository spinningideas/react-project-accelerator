        ...
        <CardFooter className="flex justify-center gap-4">
          {verificationStatus.isVerified ? (
            <Button
              ...
              className="flex w-fit rounded-full text-white bg-green-700 hover:bg-green-800 focus:outline-hidden focus:ring-4 focus:ring-green-300 font-medium text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            >
              Continue to Sign In
            </Button>
