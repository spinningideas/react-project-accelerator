                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mb-3">
                          Clone the repository and run npm install to get all
                          dependencies set up
                        </p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Update the logo, landing page content, and home
                          sections to match your brand and requirements
                        </p>
                      </div>
                    </div>
                  </CardHeader>
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Customize the About, Terms of Service, and Contact
                          pages with your information
                        </p>
                      </div>
                    </div>
                  </CardHeader>
