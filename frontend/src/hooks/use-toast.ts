...
function toastSuccess(
  ...
  return toast({ description: descriptionOrObj, variant: "success", ...(props ?? {}) })
}
...
function toastError(
  ...
  return toast({ description: descriptionOrObj, variant: "destructive", ...(props ?? {}) })
}
...
function toastInfo(
  ...
  return toast({ description: descriptionOrObj, variant: "info", ...(props ?? {}) })
}
